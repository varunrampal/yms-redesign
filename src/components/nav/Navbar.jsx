...
useEffect(() => {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-white/70 ">
      <Container className="flex h-32 items-center justify-between md:h-40">
...
<nav className="hidden items-center gap-6 text-sm md:flex">
  ...
  <Button href="/mortgageapplication" variant="gold">
   Apply Now
  </Button>
</div>
...
<div
  className={`fixed top-0 right-0 z-50 h-full w-[85%] max-w-sm
              bg-[#001E52] text-white border-l border-gray-800 shadow-2xl
...
<button
  onClick={() => setOpen(false)}
  className="absolute top-5 right-5 flex h-10 w-10 items-center justify-center rounded-full bg-[#E9AE46] hover:bg-[#D89B32] transition"
