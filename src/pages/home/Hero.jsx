...
export default function Hero() {
  ...
  <div className="-mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 md:-mt-14 lg:grid-cols-4">
    <Link
      ...
      className="group relative flex min-h-[104px] w-full items-center overflow-hidden rounded-2xl bg-[#001E52] p-6 text-white shadow-lg transition hover:bg-sky-700"
    >
      <div className="flex items-start justify-between gap-6">
        ...
        {/* <div className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-white text-xl font-extrabold transition group-hover:translate-x-0.5">
          →
        </div> */}
      </div>
    </Link>
    ...
    <Link
      ...
      className="group relative flex min-h-[104px] w-full items-center overflow-hidden rounded-2xl bg-[#E9AE46] p-6 text-white shadow-lg transition hover:bg-sky-700"
    >
      <div className="flex items-start justify-between gap-6">
        <div>
          <div className="text-lg font-extrabold leading-tight">
